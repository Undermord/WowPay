...
const (
	...
	CallbackActionAdminCategories   = "admin_categories"
	CallbackActionAdminEditCategory = "admin_edit_category"
	CallbackActionAdminEditCatName  = "admin_edit_cat_name"
	CallbackActionAdminEditCatDesc  = "admin_edit_cat_desc"
)
